...
Here is the complete step for running the tool on Windows.
...
2. Install `iwara-dl` on WSL with dependency. I'll put the code into your Windows' `Document folder`
```
sudo apt update;
cd /mnt/c/Users/hare1039/Documents/;
wget https://github.com/hare1039/iwara-dl/archive/refs/heads/master.zip;
sudo apt install unzip jq curl nkf
unzip master.zip;
rm master.zip;
cd iwara-dl-master;
```
...
After install the dependency, you can check whether the install works ok:
